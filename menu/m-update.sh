...
wget -q -O /usr/bin/online "${repo}menu/online" && chmod +x /usr/bin/online
...
wget -q -O /usr/bin/kuota-user "${repo}bot/kuota-user" && chmod +x /usr/bin/kuota-user
wget -q -O /usr/bin/onlien-vmess "${repo}bot/online-vmess" && chmod +x /usr/bin/online-vmess
wget -q -O /usr/bin/online-vless "${repo}menu/online-vless" && chmod +x /usr/bin/online-vless
wget -q -O /usr/bin/online-xray "${repo}menu/online-xray" && chmod +x /usr/bin/online-xray
wget -q -O /usr/bin/online-sshws "${repo}menu/online-sshws" && chmod +x /usr/bin/online-sshws
wget -q -O /usr/bin/online-trojan "${repo}menu/online-trojan" && chmod +x /usr/bin/online-trojan
